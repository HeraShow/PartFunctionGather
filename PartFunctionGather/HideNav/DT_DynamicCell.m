...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.publishTimeL.textColor = ColorRGB(147, 149, 152);
        ...
        self.fromL.textColor = ColorRGB(147, 149, 152);
        ...
        [self.expandBtn setTitleColor:ColorRGB(27, 188, 155) forState:UIControlStateNormal];
        ...
        self.bottomV.backgroundColor = ColorRGB(245, 251, 254);
        [self.containerV addSubview:self.bottomV];
        
        self.bottomSepV1 = [[UIView alloc] init];
        self.bottomSepV1.backgroundColor = ColorRGB(209, 211, 212);
        [self.bottomV addSubview:self.bottomSepV1];
        
        self.bottomSepV2 = [[UIView alloc] init];
        self.bottomSepV2.backgroundColor = ColorRGB(209, 211, 212);
        ...
        [self.likeBtn setImage:[UIImage imageNamed:@"wemart_love"] forState:UIControlStateNormal];
        [self.likeBtn setImage:[UIImage imageNamed:@"wemart_loved"] forState:UIControlStateSelected];
        ...
        [self.watchBtn setImage:[UIImage imageNamed:@"wemart_focus"] forState:UIControlStateNormal];
        ...
        [self.commentBtn setImage:[UIImage imageNamed:@"wemart_personal"] forState:UIControlStateNormal];
...
- (void)updateUI{
    ...
    [self.likeBtn setTitleColor:ColorRGB(240, 115, 171) forState:UIControlStateNormal];
    ...
    [self.watchBtn setTitleColor:ColorRGB(245, 130, 31) forState:UIControlStateNormal];
    ...
    [self.commentBtn setTitleColor:ColorRGB(245, 130, 31) forState:UIControlStateNormal];
